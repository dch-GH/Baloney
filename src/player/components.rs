...
impl Eye {
    ...
    pub fn local_x(&self) -> Dir3 {
        // Dir3::new(x) panics if x is of invalid length, but quat * unit Vec3or is length 1
        Dir3::new(self.view * Vec3::X).unwrap()
    }
    ...
    pub fn local_y(&self) -> Dir3 {
        // Dir3::new(x) panics if x is of invalid length, but quat * unit Vec3or is length 1
        Dir3::new(self.view * Vec3::Y).unwrap()
    }
    ...
    pub fn local_z(&self) -> Dir3 {
        // Dir3::new(x) panics if x is of invalid length, but quat * unit Vec3or is length 1
        Dir3::new(self.view * Vec3::Z).unwrap()
    }
